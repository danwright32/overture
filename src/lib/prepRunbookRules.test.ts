...
describe("prep-runbook judgment rules are present (#591)", () => {
  ...
  it("guards the concrete rules this harness cares about", () => {
    expect(RUNBOOK_RULES.map((r) => r.name).sort()).toEqual([
      ...
      "a-profile-is-not-where-the-search-stops",
      "a-subject-never-ends-in-punctuation",
      ...
      "dan-is-the-subject-of-the-trade-clause",
      ...
      "rank-from-how-this-show-bills-them",
      ...
      "the-billed-hierarchy-decides-the-target",
      "the-city-not-the-state",
      "the-credit-may-carry-a-role-search-the-name",
      "the-hedge-names-what-it-is-about",
