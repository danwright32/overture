# Worktrees, parallel agents, verifying and merging

How several sessions share this repo, how a branch is verified against current main before it
merges, what the merge scripts refuse and why, and what CI does and does not cover.
