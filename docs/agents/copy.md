...
Every sentence Overture can say, to Dan and to strangers, the generated documents that hold them, and the cold read that is the only thing catching what no test can.
...
## A store wide count quoted in prose
...
## Changing the AI drafting instructions
...
## The regression harness for the runbook's judgment
