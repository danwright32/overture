# Builds, the project file, and per clone setup

The Debug and Release builds, the signing identity, the git hooks every clone installs once,
and reclaiming Xcode's build output.
