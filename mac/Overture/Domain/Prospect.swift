...
final class Prospect {
    ...
    //
    // #2910: an ending Dan recorded on the show is deliberately NOT one of the exclusions, and the
    // reasoning is on `Recipient.hasUnhandledReply`. `booked` stays, and stays HERE: it is not a
