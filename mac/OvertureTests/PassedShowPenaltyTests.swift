...
struct PassedShowPenaltyTests {
    ...
    @Test func aShowDanPassedOnScoresLowerWhenItComesBackToTheSameVenue() throws {
        ...
        _ = ScoutService.apply(events: [auroraAtWeill], clients: [], history: [], blocked: [], into: ctx)
        ...
        _ = ScoutService.apply(events: [nextSeason], clients: [], history: history, blocked: [], into: ctx)
    ...
    @Test func theSameOrgAtANewVenueComesBackAtFullScore() throws {
        ...
        _ = ScoutService.apply(events: [auroraElsewhere], clients: [], history: [], blocked: [], into: control)
        ...
        _ = ScoutService.apply(events: [auroraElsewhere], clients: [], history: history, blocked: [], into: ctx)
