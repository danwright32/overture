...
struct OrgDoNotContactTests {
    ...
    @Test func anUnrelatedOrgIsCompletelyUnaffected() throws {
        ...
        _ = ScoutService.apply(events: [other], clients: [], history: history, blocked: [], into: ctx)
    ...
    @Test func aMerelySimilarNameIsNotSilentlyDropped() throws {
        ...
        _ = ScoutService.apply(events: [different], clients: [], history: history, blocked: [], into: ctx)
    ...
    @Test func unmarkingReleasesTheOrgForFutureScouts() throws {
        ...
        _ = ScoutService.apply(events: [returning], clients: [], history: history, blocked: [], into: ctx)
